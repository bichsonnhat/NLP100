...
train, train_test = train_test_split(df, test_size = 0.8, shuffle = True, random_state = 42,  stratify=df['CATEGORY'])
...
# type(train) is list 
valid, valid_test = train_test_split(df, test_size = 0.1, shuffle = True, random_state = 42,  stratify=df['CATEGORY'])
test, test_test = train_test_split(df, test_size = 0.1, shuffle = True, random_state = 42,  stratify=df['CATEGORY'])
